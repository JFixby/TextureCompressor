...
public class IndexedCompressor {
    ...
    public static final int DEFAULT_RED_PALETTE_SIZE = 16 * 2;
    public static final int DEFAULT_GREEN_PALETTE_SIZE = 32 * 2;
    public static final int DEFAULT_BLUE_PALETTE_SIZE = 16 * 2;
